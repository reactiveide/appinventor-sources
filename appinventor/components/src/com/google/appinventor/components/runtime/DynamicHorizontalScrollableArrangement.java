...
/*@DesignerComponent(version = 1,  description = "Creates Dynamic Horizontal Scrollable Arrangement",
        ...
        nonVisible = true,
        iconName = "https://cdn.reactiveide.com/horizontal.png")
@SimpleObject*/
public class DynamicHorizontalScrollableArrangement extends AndroidNonvisibleComponent {
    private ComponentContainer container;
    private Context context; //Added
    private Activity activity; //Added
    public static ViewGroup vg;
 
    public DynamicHorizontalScrollableArrangement(ComponentContainer container) {

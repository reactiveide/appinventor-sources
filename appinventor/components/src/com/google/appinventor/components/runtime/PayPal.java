...
@DesignerComponent(version = 1, description = "", category = ComponentCategory.MONITIZATION, nonVisible = true, iconName = "https://res.cloudinary.com/dfozqceqg/image/upload/v1581122053/paypal.png")
@SimpleObject
...
@UsesLibraries(libraries="paypal.jar , okhttp.jar , okio.jar")

public class PayPal extends AndroidNonvisibleComponent {
    ...
    public PayPal(ComponentContainer container) {
